...
public class DDNSRunable implements Runnable {
...
//                "");// 您的AccessKey Secret
        ...
        DescribeDomainRecordsResponse describeDomainRecordsResponse = DDNSRunable.describeDomainRecords(describeDomainRecordsRequest, client);
        DDNSRunable.log_print("describeDomainRecords", describeDomainRecordsResponse);
        ...
        if (domainRecords.size() != 0) {
            ...
            // 当前主机公网IP
            String currentHostIP = DDNSRunable.getCurrentHostIP();
            System.out.println("-------------------------------当前主机公网IP为：" + currentHostIP + "-------------------------------");
            System.out.println("-------------------------------当前A记录IP为：" + recordsValue + "-------------------------------");
            if (!currentHostIP.equals(recordsValue)) {
                ...
                UpdateDomainRecordResponse updateDomainRecordResponse = DDNSRunable.updateDomainRecord(updateDomainRecordRequest, client);
                DDNSRunable.log_print("updateDomainRecord", updateDomainRecordResponse);
            }
        }
    }
